...
class VBox {
    ...
    _count: number = 0;
    _avg: any;
    public constructor(private r1, private r2, private g1, private g2, private b1, private b2, private histo) {
        this.r1 = r1;
        this.r2 = r2;
        this.g1 = g1;
        this.g2 = g2;
...
// histo (1-d array, giving the number of pixels in
    ...
    export function quantize(pixels, maxcolors) {
        ...
        var vbox = vboxFromPixels(pixels, histo),
            pq: any = new PQueue(function(a, b) {
        ...
        function iter(lh, target) {
            ...
            while (niters < maxIterations) {
                ...
                // do the cut
                var vboxes: any = medianCutApply(histo, vbox),
                    vbox1 = vboxes[0],
                    vbox2 = vboxes[1];
        ...
        var pq2: any = new PQueue(function(a, b) {
