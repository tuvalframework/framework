...
export interface GenericPrivateMethodConfig {
  name: string;
  returnType: Type;
  isAbstract: boolean;
  isVirtual: boolean;
...
export class GenericPrivateMethodInfo extends MethodInfo {
  ...
  public constructor(/* config?: GenericPrivateMethodConfig */) {
    super(/* {
