...
export interface PublicMethodConfig {
    name: string
    returnType: Type;
}

export class PublicMethodInfo extends MethodInfo {
    ...
    public constructor(/* config?: PublicMethodConfig */) {
        super(/* {
...
export class PublicStaticMethodInfo extends MethodInfo {
    public GetMethodImplementationFlags(): MethodImplAttributes {
        throw new Error("Method not implemented.");
    }
    public GetParameters(): ParameterInfo[] {
