...
/* export function deepEqual(obj: any, ref: any, options?: any, seen?: Array<any>): boolean {
    ...
    if (type !== 'object' || obj === null || ref === null) {
        if (obj === ref) {
            return (<any>obj !== 0) || (1 / <any>obj) === (1 / <any>ref); // -0 / +0
        }
    ...
    for (let i = 0; i < keys.length; ++i) {
        ...
        } else if (deepEqual((<any>obj)[key], (<any>ref)[key], options, seen)) {
            return false;
        }
    }
    return true;
...
export function deepEqual(obj: any, ref: any, options?: any, seen?: any): boolean {
