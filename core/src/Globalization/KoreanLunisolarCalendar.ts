...
export class KoreanLunisolarCalendar extends EastAsianLunisolarCalendar {
    ...
    public static readonly GregorianEra: int = 1;

    //internal static Calendar m_defaultInstance;

    public /* internal */ static readonly MIN_LUNISOLAR_YEAR: int = 918;
    public /* internal */ static readonly MAX_LUNISOLAR_YEAR: int = 2050;

    public /* internal */ static readonly MIN_GREGORIAN_YEAR: int = 918;
    public /* internal */ static readonly MIN_GREGORIAN_MONTH: int = 2;
    public /* internal */ static readonly MIN_GREGORIAN_DAY: int = 14;
    ...
    public /* internal */ static minDate: DateTime = new DateTime(KoreanLunisolarCalendar.MIN_GREGORIAN_YEAR, KoreanLunisolarCalendar.MIN_GREGORIAN_MONTH, KoreanLunisolarCalendar.MIN_GREGORIAN_DAY);
    public /* internal */ static maxDate: DateTime = new DateTime((new DateTime(KoreanLunisolarCalendar.MAX_GREGORIAN_YEAR, KoreanLunisolarCalendar.MAX_GREGORIAN_MONTH, KoreanLunisolarCalendar.MAX_GREGORIAN_DAY, 23, 59, 59, 999)).Ticks.add(9999));
...
*/];
    ...
    protected Get_MinCalendarYear(): int {
        return (KoreanLunisolarCalendar.MIN_LUNISOLAR_YEAR);
    }

    @Override
    protected Get_MaxCalendarYear(): int {
        return KoreanLunisolarCalendar.MAX_LUNISOLAR_YEAR;
    }
    ...
    public GetYearInfo(LunarYear: int, Index: int): int {
        if ((LunarYear < KoreanLunisolarCalendar.MIN_LUNISOLAR_YEAR) || (LunarYear > KoreanLunisolarCalendar.MAX_LUNISOLAR_YEAR)) {
            throw new ArgumentOutOfRangeException(
                "year",
                TString.Format(
                    /* CultureInfo.CurrentCulture, */
                    Environment.GetResourceString("ArgumentOutOfRange_Range"),
                    KoreanLunisolarCalendar.MIN_LUNISOLAR_YEAR,
                    KoreanLunisolarCalendar.MAX_LUNISOLAR_YEAR));
        }
        // Contract.EndContractBlock();
        return KoreanLunisolarCalendar.yinfo[LunarYear - KoreanLunisolarCalendar.MIN_LUNISOLAR_YEAR][Index];
    }
    ...
    public GetGregorianYear(year: int, era: int): int {
        if (era !== Calendar.CurrentEra && era !== KoreanLunisolarCalendar.GregorianEra)
            throw new ArgumentOutOfRangeException("era", Environment.GetResourceString("ArgumentOutOfRange_InvalidEraValue"));

        if (year < KoreanLunisolarCalendar.MIN_LUNISOLAR_YEAR || year > KoreanLunisolarCalendar.MAX_LUNISOLAR_YEAR) {
            throw new ArgumentOutOfRangeException(
                "year",
                TString.Format(
                    /* CultureInfo.CurrentCulture, */
                    Environment.GetResourceString("ArgumentOutOfRange_Range"), KoreanLunisolarCalendar.MIN_LUNISOLAR_YEAR, KoreanLunisolarCalendar.MAX_LUNISOLAR_YEAR));
        }
        //Contract.EndContractBlock();
    ...
    */
    ...
    public GetEra(time: DateTime): int {
        ...
        return KoreanLunisolarCalendar.GregorianEra;
    }

    @Override
    protected Get_BaseCalendarID(): int {
        return Calendar.CAL_KOREA;
    }

    @Override
    protected Get_ID(): int {
        return Calendar.CAL_KOREANLUNISOLAR;
    }
    ...
    public Get_Eras(): IntArray {
        return New.IntArray([KoreanLunisolarCalendar.GregorianEra]);
    }
}