...
export class TaiwanLunisolarCalendar extends EastAsianLunisolarCalendar {
    ...
    public static /* internal */  taiwanLunisolarEraInfo: EraInfo[] = [new EraInfo(1, 1912, 1, 1, 1911, 1, GregorianCalendar.MaxYear - 1911)];    // era #, start year/month/day, yearOffset, minEraYear

    public /* internal */  helper: GregorianCalendarHelper;

    public /* internal */ static readonly MIN_LUNISOLAR_YEAR: int = 1912;
    public /* internal */ static readonly MAX_LUNISOLAR_YEAR: int = 2050;

    public /* internal */ static readonly MIN_GREGORIAN_YEAR: int = 1912;
    public /* internal */ static readonly MIN_GREGORIAN_MONTH: int = 2;
    public /* internal */ static readonly MIN_GREGORIAN_DAY: int = 18;

    public /* internal */ static readonly MAX_GREGORIAN_YEAR: int = 2051;
    public /* internal */ static readonly MAX_GREGORIAN_MONTH: int = 2;
    public /* internal */ static readonly MAX_GREGORIAN_DAY: int = 10;

    public /* internal */ static minDate: DateTime = new DateTime(TaiwanLunisolarCalendar.MIN_GREGORIAN_YEAR, TaiwanLunisolarCalendar.MIN_GREGORIAN_MONTH, TaiwanLunisolarCalendar.MIN_GREGORIAN_DAY);
    public /* internal */ static maxDate: DateTime = new DateTime((new DateTime(TaiwanLunisolarCalendar.MAX_GREGORIAN_YEAR, TaiwanLunisolarCalendar.MAX_GREGORIAN_MONTH, TaiwanLunisolarCalendar.MAX_GREGORIAN_DAY, 23, 59, 59, 999)).Ticks.add(9999));
...
2050    */[3, 1, 23, 21936],/*    29    30    29    30    29    30    29    30    30    29    30    30    29    384
    ...
    protected Get_MinCalendarYear(): int {
        return TaiwanLunisolarCalendar.MIN_LUNISOLAR_YEAR;
    }

    @Override
    protected Get_MaxCalendarYear(): int {
        return TaiwanLunisolarCalendar.MAX_LUNISOLAR_YEAR;
    }
    ...
    @Override
    @Internal
    public GetYearInfo(LunarYear: int, Index: int): int {
        if ((LunarYear < TaiwanLunisolarCalendar.MIN_LUNISOLAR_YEAR) || (LunarYear > TaiwanLunisolarCalendar.MAX_LUNISOLAR_YEAR)) {
            throw new ArgumentOutOfRangeException(
                "year",
                TString.Format(
                    /* CultureInfo.CurrentCulture, */
                    Environment.GetResourceString("ArgumentOutOfRange_Range"),
                    TaiwanLunisolarCalendar.MIN_LUNISOLAR_YEAR,
                    TaiwanLunisolarCalendar.MAX_LUNISOLAR_YEAR));
        }
        // Contract.EndContractBlock();

        return TaiwanLunisolarCalendar.yinfo[LunarYear - TaiwanLunisolarCalendar.MIN_LUNISOLAR_YEAR][Index];
    }
    ...
    @Internal
    @Override
    public GetGregorianYear(year: int, era: int): int {
    ...
    */
    ...
    protected Get_BaseCalendarID(): int {
        return (TaiwanLunisolarCalendar.CAL_TAIWAN);
    }

    @Override
    protected Get_ID() {
        return TaiwanLunisolarCalendar.CAL_TAIWANLUNISOLAR;
    }
