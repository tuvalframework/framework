...
import { int, New, IntArray } from '../float';
...
export class ChineseLunisolarCalendar extends EastAsianLunisolarCalendar {
    ...
    public static readonly ChineseEra: int = 1;
    //internal static Calendar m_defaultInstance;

    public /* internal */ static readonly MIN_LUNISOLAR_YEAR: int = 1901;
    public /* internal */ static readonly MAX_LUNISOLAR_YEAR: int = 2100;

    public /* internal */ static readonly MIN_GREGORIAN_YEAR: int = 1901;
    public /* internal */ static readonly MIN_GREGORIAN_MONTH: int = 2;
    public /* internal */ static readonly MIN_GREGORIAN_DAY: int = 19;

    public /* internal */ static readonly MAX_GREGORIAN_YEAR: int = 2101;
    public /* internal */ static readonly MAX_GREGORIAN_MONTH: int = 1;
    public /* internal */ static readonly MAX_GREGORIAN_DAY: int = 28;

    public /* internal */ static minDate: DateTime = new DateTime(ChineseLunisolarCalendar.MIN_GREGORIAN_YEAR, ChineseLunisolarCalendar.MIN_GREGORIAN_MONTH, ChineseLunisolarCalendar.MIN_GREGORIAN_DAY);
    public /* internal */ static maxDate: DateTime = new DateTime((new DateTime(ChineseLunisolarCalendar.MAX_GREGORIAN_YEAR, ChineseLunisolarCalendar.MAX_GREGORIAN_MONTH, ChineseLunisolarCalendar.MAX_GREGORIAN_DAY, 23, 59, 59, 999)).Ticks.add(9999));
    ...
    public static readonly yinfo: int[][] =
        [
...
2100    */[0, 2, 9, 54560],/*    30    30    29    30    29    30    29    30    29    29    30    29    0    354
    */];
    ...
    @Override
    protected /* internal */  Get_MinCalendarYear(): int {
        return ChineseLunisolarCalendar.MIN_LUNISOLAR_YEAR;
    }

    @Override
    protected /* internal */  Get_MaxCalendarYear(): int {
        return ChineseLunisolarCalendar.MAX_LUNISOLAR_YEAR;
    }

    @Override
    protected /* internal */   Get_MinDate(): DateTime {
        return ChineseLunisolarCalendar.minDate;
    }

    @Override
    protected /* internal */ Get_MaxDate(): DateTime {
        return ChineseLunisolarCalendar.maxDate;
    }

    @Override
    protected/* internal */ Get_CalEraInfo(): EraInfo[] {
        return null as any;
    }

    @Override
    public/* internal */    GetYearInfo(LunarYear: int, Index: int): int {
        if ((LunarYear < ChineseLunisolarCalendar.MIN_LUNISOLAR_YEAR) || (LunarYear > ChineseLunisolarCalendar.MAX_LUNISOLAR_YEAR)) {
            throw new ArgumentOutOfRangeException(
                "year",
                TString.Format(
                    /* CultureInfo.CurrentCulture, */
                    Environment.GetResourceString("ArgumentOutOfRange_Range"), ChineseLunisolarCalendar.MIN_LUNISOLAR_YEAR, ChineseLunisolarCalendar.MAX_LUNISOLAR_YEAR));
        }
        //Contract.EndContractBlock();

        return ChineseLunisolarCalendar.yinfo[LunarYear - ChineseLunisolarCalendar.MIN_LUNISOLAR_YEAR][Index];
    }
    ...
    public /* internal */   GetGregorianYear(year: int, era: int): int {
        if (era !== ChineseLunisolarCalendar.CurrentEra && era !== ChineseLunisolarCalendar.ChineseEra) {
            throw new ArgumentOutOfRangeException("era", Environment.GetResourceString("ArgumentOutOfRange_InvalidEraValue"));
        }

        if (year < ChineseLunisolarCalendar.MIN_LUNISOLAR_YEAR || year > ChineseLunisolarCalendar.MAX_LUNISOLAR_YEAR) {
            throw new ArgumentOutOfRangeException(
                "year",
                TString.Format(
                    /* CultureInfo.CurrentCulture, */
    ...
    */
    ...
    public GetEra(time: DateTime): int {
        ...
        return ChineseLunisolarCalendar.ChineseEra;
    }

    @Override
    protected/* internal */   Get_ID(): int {
        return (ChineseLunisolarCalendar.CAL_CHINESELUNISOLAR);
    }

    @Override
    protected /* internal */   Get_BaseCalendarID(): int {
        //Use CAL_GREGORIAN just to get CurrentEraValue as 1 since we do not have data under the ID CAL_ChineseLunisolar yet
        return ChineseLunisolarCalendar.CAL_GREGORIAN;
    }


    @Override
    protected Get_Eras(): IntArray {
        return New.IntArray([ChineseLunisolarCalendar.ChineseEra]);
    }
}