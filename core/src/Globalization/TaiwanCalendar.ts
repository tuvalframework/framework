...
export class TaiwanCalendar extends Calendar {
    ...
    public static /* internal */  taiwanEraInfo: EraInfo[] = [
    ...
    **Exceptions:
    ...
    public /* internal */ static readonly calendarMinValue: DateTime = new DateTime(1912, 1, 1);
    ...
    protected Get_ID(): int {
        return TaiwanCalendar.CAL_TAIWAN;
    }
    ...
    protected Get_TwoDigitYearMax(): int {
        if (this.twoDigitYearMax == -1) {
            this.twoDigitYearMax = TaiwanCalendar.GetSystemTwoDigitYearSetting(this.ID, TaiwanCalendar.DEFAULT_TWO_DIGIT_YEAR_MAX);
        }
