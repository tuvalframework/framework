...
export const ContextMenu = React.memo(React.forwardRef((props, ref) => {
    ...
    const createContextMenu = () => {
        const otherProps = ObjectUtils.findDiffKeys(props, (ContextMenu as any).defaultProps);
    ...
    return React.createPortal(element, props.appendTo || document.body)
    // return <Portal element={element} appendTo={props.appendTo} />
}));

//ContextMenu.displayName = 'ContextMenu';
(ContextMenu as any).defaultProps = {
    __TYPE: 'ContextMenu',
    id: null,
    model: null,
    style: null,
