...
import { CSSTransition } from '../../../windows/Forms/Components/csstransition/CSSTransition';
...
import { DomHandler as DOMH } from "../../../windows/Forms/Components/DomHandler";

DOMH.addCssToDocument(require('./OverlayPanel.css'));
DOMH.addCssToDocument(require('./Thema.css'));

export const OverlayPanel: any = React.forwardRef((props, ref) => {
