...
import { DomHandler as OldDomHandler} from "../../../windows/Forms/Components/DomHandler";
...
export const Menu = React.memo(React.forwardRef((props, ref) => {
    ...
    const createElement = () => {
        if (props.model) {
            const otherProps = ObjectUtils.findDiffKeys(props, (Menu as any).defaultProps);
