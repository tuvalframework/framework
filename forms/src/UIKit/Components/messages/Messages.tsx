...
import { TransitionGroup } from '../../../windows/Forms/Components/csstransition/TransitionGroup';
...
export const Messages = React.memo(React.forwardRef((props, ref) => {
    ...
    const otherProps = ObjectUtils.findDiffKeys(props, (Messages as any).defaultProps);
