...
export const InputNumber: any = React.memo(React.forwardRef((props, ref) => {
    ...
    const constructParser = () => {
        ...
        const numerals = [...new (Intl as any).NumberFormat(props.locale, { useGrouping: false }).format(9876543210)].reverse();
    ...
    const getCurrencyExpression = () => {
        if (props.currency) {
            const formatter = new (Intl as any).NumberFormat(props.locale, {
    ...
    const getPrefixExpression = () => {
        if (props.prefix) {
            ...
            const formatter = new (Intl as any).NumberFormat(props.locale, { style: props.mode, currency: props.currency, currencyDisplay: props.currencyDisplay });
