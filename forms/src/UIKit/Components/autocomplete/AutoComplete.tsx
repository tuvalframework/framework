...
export const AutoComplete = React.memo(React.forwardRef((props, ref) => {
    ...
    useUpdateEffect(() => {
        ...
        if (searchingState) {
            console.log('searchingState:start');
            ObjectUtils.isNotEmpty(props.suggestions) ? show() : hide();
            setSearchingState(false);
            console.log('searchingState:end');
        }
    }, [props.suggestions]);
    ...
    const createSimpleAutoComplete = () => {
        ...
        return (
            <InputText ref={inputRef} id={props.inputId} type={props.type} name={props.name} defaultValue={value}
                ...
                onBlur={onInputBlur} onFocus={onInputFocus} onInput={onInputChange}
    ...
    const otherProps = ObjectUtils.findDiffKeys(props, (AutoComplete as any).defaultProps);
...
(AutoComplete as any).defaultProps = {
    __TYPE: 'AutoComplete',
    id: null,
    inputRef: null,
    value: null,
