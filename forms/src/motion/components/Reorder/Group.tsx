...
export function ReorderGroup<V>(
    {
        ...
        values,
        ...props
    }: any/* Props<V> & HTMLMotionProps<any> & React.PropsWithChildren<{}> */,
    externalRef?: any/* React.Ref<any> */
) {
    const Component = useConstant(() => motion(as)) as any/* FunctionComponent<HTMLMotionProps<any> & { ref?: React.Ref<any> }> */
