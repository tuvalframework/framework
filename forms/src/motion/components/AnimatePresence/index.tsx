...
import { Children, cloneElement, Fragment, isValidElement } from "../../../preact/compat"
import { useContext, useRef } from "../../../hooks"
import { Teact } from "../../../windows/Forms/Components/Teact"

type ComponentKey = string | number

const getChildKey = (child: any/* PreactElement<any> */): ComponentKey => child.key || ""

const isDev = process.env.NODE_ENV !== "production"

function updateChildLookup(
    children: any/* ReactElement<any>[] */,
    allChildren: Map<ComponentKey, any/* ReactElement<any> */>
) {
...
function onlyElements(children: any/* ReactNode */):any /* ReactElement<any>[]  */{
    const filtered: any /* ReactElement<any>[] */ = []
 ...
 * @public
 */
export const AnimatePresence: any/* React.FunctionComponent<React.PropsWithChildren<AnimatePresenceProps>> */ = ({
    children,
    custom,
    initial = true,
    onExitComplete,
    ...
    const allChildren = useRef(
        new Map<ComponentKey,any/* ReactElement<any> */>()
    ).current
