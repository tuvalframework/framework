...
export function createProjectionNode<I>({
    ...
    return class ProjectionNode implements IProjectionNode<I> {
        ...
        constructor(
            ...
            this.root = (parent ? parent.root || parent : this) as any
            this.path = parent ? [...parent.path, parent] : []
            this.parent = parent

            this.depth = parent ? parent.depth + 1 : 0

            id && this.root.registerPotentialNode(id, this as any)
        ...
        mount(instance: I, isLayoutDirty = false) {
            ...
            this.parent?.children.add(this as any)
            ...
            if (attachResizeListener) {
                ...
                attachResizeListener(instance, () => {
                    ...
                    if (globalProjectionState.hasAnimatedSinceResize) {
                        ...
                        this.nodes!.forEach(finishAnimation as any)
                    }
                })
            }

            if (layoutId) {
                this.root.registerSharedNode(layoutId, this as any)
            }
        ...
        unmount() {
            ...
            this.getStack()?.remove(this as any)
            this.parent?.children.delete(this as any)
        ...
        startUpdate() {
            ...
            this.nodes?.forEach(resetRotation as any)
        }
        ...
        didUpdate() {
            ...
            if (updateWasBlocked) {
                ...
                this.nodes!.forEach(clearMeasurements as any)
                return
            }
             ...
             * Write
             */
            this.nodes!.forEach(resetTransformStyle as any)

            /**
             * Read ==================
             */
            // Update layout measurements of updated children
            this.nodes!.forEach(updateLayout as any)

            /**
             * Write
             */
            // Notify listeners that the layout is updated
            this.nodes!.forEach(notifyLayoutUpdate as any)
            this.clearAllSnapshots()
        ...
        clearAllSnapshots() {
            this.nodes!.forEach(clearSnapshot as any)
        ...
        updateProjection = () => {
            this.nodes!.forEach(resolveTargetDelta as any)
            this.nodes!.forEach(calcProjection as any)
        }
        ...
        promote({
            ...
            const stack = this.getStack()
            if (stack) stack.promote(this as any, preserveFollowOpacity)
        ...
        relegate(): boolean {
            const stack = this.getStack()
            if (stack) {
                return stack.relegate(this as any)
            } else {
                return false
            }
        }
        ...
        // Only run on root
        resetTree() {
            (this as any).root.nodes!.forEach((node: IProjectionNode) =>
                node.currentAnimation?.stop()
            )
            this.root.nodes!.forEach(clearMeasurements as any)
