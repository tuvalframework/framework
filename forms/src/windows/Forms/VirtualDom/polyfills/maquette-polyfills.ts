(function (global) {
  ...
  if (!Array.isArray) {
    (<any>Array).isArray = function (arg): boolean {
  ...
  if (!("classList" in document.documentElement)) {
    (function (join, splice, createElement) {
      if (object_defineProperty) {
        ...
        (<any>classListProto).item = function (i) {
          return this[i] || null;
        };

        (<any>classListProto).contains = function (token) {
          token += "";
          return checkTokenAndGetIndex(this, token) !== -1;
        };

        (<any>classListProto).add = function () {
        ...
        (<any>classListProto).remove = function () {
          var tokens = arguments;
          var i = 0;
          var l = tokens.length;
          var token;
        ...
        (<any>classListProto).toggle = function (token, force) {
          token += "";
        ...
        var fromObject = function (self, object) {
          ...
          splice.apply(self, [0, self.length].concat(array) as any);
        };
  ...
  if (!document.createElementNS) {
    (function (createElement) {
      ...
      document.createElementNS = function (namespace: any, tagName: any) {
