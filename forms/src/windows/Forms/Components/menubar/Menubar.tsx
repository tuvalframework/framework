...
export class Menubar extends React.Component {
    ...
    render() {
        const className = classNames('p-menubar p-component', { 'p-menubar-mobile-active': this.state.mobileActive } as any, this.props.className);
