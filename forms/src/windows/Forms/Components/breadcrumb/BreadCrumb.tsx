...
import React, { createElement, createRef, Portal } from '../../../../preact/compat';
...
const css = require('./BreadCrumb.css');
...
export class BreadCrumb extends React.Component {
    ...
    renderHome() {
        if (this.props.home) {
            const className = classNames('p-breadcrumb-home', { 'p-disabled': this.props.home.disabled } as any, this.props.home.className);
    ...
    renderMenuitem(item) {
        const className = classNames(item.className, { 'p-disabled': item.disabled } as any);
