...
const css = require('./VirtualScroller.css');
DomHandler.addCssToDocument(css);

export class VirtualScroller extends React.Component {
    ...
    calculateOptions() {
        ...
        const numItemsInViewport: any = isBoth ?
        ...
        const calculateLast: any = (_first, _num, _isCols) => this.getLast(_first + _num + ((_first < numToleratedItems ? 2 : 3) * numToleratedItems), _isCols);
        const last = isBoth ?
    ...
    onScrollPositionChange(event) {
        ...
        const calculateLast: any = (_currentIndex, _first, _last, _num, _isCols) => {
