...
export class FirstPageLink extends React.Component {
    ...
    render() {
        const className = classNames('p-paginator-first p-paginator-element p-link', { 'p-disabled': this.props.disabled } as any);
