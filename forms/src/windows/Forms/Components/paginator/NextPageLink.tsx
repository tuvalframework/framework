...
export class NextPageLink extends React.Component {
    ...
    render() {
        const className = classNames('p-paginator-next p-paginator-element p-link', { 'p-disabled': this.props.disabled } as any);
