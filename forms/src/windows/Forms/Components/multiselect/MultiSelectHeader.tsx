...
export class MultiSelectHeader extends React.Component {
    ...
    render() {
        ...
        const checkboxElement = this.props.showSelectAll && <CheckboxComponent checked={this.props.selectAll} onChange={this.onSelectAll} role="checkbox" aria-checked={this.props.selectAll} />;
        const closeElement = (
