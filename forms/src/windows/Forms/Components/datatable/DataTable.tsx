...
export class DataTable extends React.Component {
    ...
    columnWidthsState: any;
    tableWidthState: any;
    container: any;
    table: any;
    columnSortable: any;
    columnSortFunction: any;
    columnField: any;
    defaultSortOrder: any;
    resizeColumn: any;
    resizeColumnProps: any;
    columnResizing: any;
    ...
    _restoreState(restoredState, state: any = {}) {
    ...
    restoreColumnWidths() {
        if (this.columnWidthsState) {
            ...
            if (this.props.scrollable) {
                let headerCols: any = DomHandler.find(this.container, '.p-datatable-scrollable-header-table > colgroup > col');
                let bodyCols: any = DomHandler.find(this.container, '.p-datatable-scrollable-body-table > colgroup > col');

                headerCols.map((col, index) => col.style.width = widths[index] + 'px');
                bodyCols.map((col, index) => col.style.width = widths[index] + 'px');
            }
            else {
                let headers: any = DomHandler.find(this.table, '.p-datatable-thead > tr > th');
    ...
    unbindColumnResizeEvents() {
        (document as any).removeEventListener('document', this.documentColumnResizeListener);
        (document as any).removeEventListener('document', this.documentColumnResizeEndListener);
    }
    ...
    exportCSV(options) {
        ...
        if((window as any).navigator.msSaveOrOpenBlob) {
            (navigator as any).msSaveOrOpenBlob(blob, this.props.exportFilename + '.csv');
        }
        else {
    ...
    getScrollableColumns(columns) {
        let scrollableColumns: any = null;
    ...
    render() {
        ...
        let className = classNames('p-datatable p-component', {
                        ...
                        'p-datatable-auto-layout': this.props.autoLayout, 'p-datatable-hoverable-rows': this.props.rowHover || this.props.selectionMode || selectionModeInColumn} as any, this.props.className);
