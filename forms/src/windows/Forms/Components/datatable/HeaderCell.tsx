...
export class HeaderCell extends React.Component {
    ...
    render() {
        ...
        if (this.props.columnProps.filter && this.props.renderOptions.renderFilter) {
            filterElement = this.props.columnProps.filterElement || <TuInputElement onChange={this.onFilterChange} type={this.props.columnProps.filterType} value={this.state.filterValue}
        ...
        if (this.props.renderOptions.filterOnly) {
            ...
            } as any, this.props.columnProps.headerClassName || this.props.columnProps.className);
