...
export class Ripple extends React.Component {
    ...
    public static getTeactInstance(props: any) {
        return new Ripple(props);
    }
    render() {
        return /* TuvalTeact.ripple && */ (<span ref={(el => this.ink = el)} className="p-ink" onAnimationEnd={this.onAnimationEnd}></span>);
    }
}