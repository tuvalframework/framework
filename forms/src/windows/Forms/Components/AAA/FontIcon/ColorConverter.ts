 ...
 */
export const hsv2hsl = function (h, s, v) {
    var l = ((200 - s) * v) / 100;
 ...
 */
export const hsl2hsv = function (h, s, l) {
 ...
 * @returns Object {r:redValue,g:greenValue,b:blueValue,a:alphaValue}
 */
export const hex2rgb = function (str) {
    var r = 0;
    var g = 0;
    var b = 0;
    var a = 1;
 ...
 * @returns Object {r:redValue,g:greenValue,b:blueValue,a:alphaValue}
 */
export const str2rgb = function (str) {
    var r = 0;
    var g = 0;
    var b = 0;
    var a = 1;
 ...
 * @returns Object {h:hueValue,s:saturationValue,l:lightnessValue}
 */
export const str2hsl = function (str) {
    var h = 0;
    var s = 0;
    var l = 0;
    var a = 1;
 ...
 */
export const rgba2hexa = function (r, g, b, a) {
...
/**
 * ;string color value rgb/hsl/hex/named and return object having properties
 * {
 * r: number - red value
 ...
 */
export function ColorConverter(strColor): ColorInfo {
    var r: any = 0;
    var g: any = 0;
    var b: any = 0;
    var h: any = 0;
    ...
    if (str.match(/^rgb\(\d+\s*,\s*\d+\s*,\s*\d+\)|^rgba\(\d+\s*,\s*\d+\s*,\s*\d+\s*,\s*[\d.]+\)/g)) {
        var rgba_1 = str2rgb(str);
        if (rgba_1) {
            r = rgba_1.r;
            g = rgba_1.g;
            b = rgba_1.b;
            a = rgba_1.a;
            var hsl_1 = rgb2hsl(r, g, b);
            h = hsl_1.h;
            s = hsl_1.s;
            l = hsl_1.l;
        }
        ...
        var hsl_2 = str2hsl(str);
        h = hsl_2.h;
        s = hsl_2.s;
        l = hsl_2.l;
        a = hsl_2.a;
        var rgb_1 = hsl2rgb(h, s, l);
        r = rgb_1.r;
        g = rgb_1.g;
        b = rgb_1.b;
    }
        ...
        if (str.match(/^#[0-9a-f]+$/i)) {
            if (str.length === 4 || str.length === 7 || str.length === 9) {
                var rgba_2 = hex2rgb(str);
                r = rgba_2.r;
                g = rgba_2.g;
                b = rgba_2.b;
                a = rgba_2.a;
                var hsl_3 = rgb2hsl(r, g, b);
                h = hsl_3.h;
                s = hsl_3.s;
                l = hsl_3.l;
            }
        ...
        var rgba_3 = hex2rgb(colorsList[str]);
        r = rgba_3.r;
        g = rgba_3.g;
        b = rgba_3.b;
        a = rgba_3.a;
        var hsl_4 = rgb2hsl(r, g, b);
        h = hsl_4.h;
        s = hsl_4.s;
        l = hsl_4.l;
    }
