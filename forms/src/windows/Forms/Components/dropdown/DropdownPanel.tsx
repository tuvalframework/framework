...
class DropdownPanelComponent extends React.Component {
    ...
    renderFilter() {
        if (this.props.filter) {
            ...
            const containerClassName = classNames('p-dropdown-filter-container', { 'p-dropdown-clearable-filter': !!clearIcon } as any);
            return (
