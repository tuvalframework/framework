...
export class DropdownComponent extends React.Component {
    ...
    search(event) {
        ...
        if (this.searchValue) {
            ...
            let newOption = this.props.optionGroupLabel ? this.searchOptionInGroup(searchIndex) : this.searchOption(++(searchIndex as any));
            if (newOption) {
                this.selectItem({
                    originalEvent: event,
                    option: newOption
    ...
    getSelectedOption() {
        let index: any = this.getSelectedOptionIndex();
        let visibleOptions = this.getVisibleOptions()
    ...
    scrollInView() {
        ...
        if (highlightItem) {
            ...
            highlightItem.scrollIntoView({ behavior: 'smooth', block: 'nearest', inline: 'start' });
            window.scrollTo(0,0);
            //highlightItem.parentNode.scrollTop = highlightItem.offsetTop;
        }
    }
