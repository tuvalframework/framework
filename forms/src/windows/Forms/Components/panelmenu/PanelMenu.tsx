...
export class PanelMenuSub extends React.Component {
    ...
    renderSubmenu(item, active) {
        const submenuWrapperClassName = classNames('p-toggleable-content', { 'p-toggleable-content-collapsed': !active } as any);
    ...
    renderMenuitem(item, index) {
        ...
        const submenuIconClassName = classNames('p-panelmenu-icon pi pi-fw', { 'pi-angle-right': !active, 'pi-angle-down': active } as any);
...
export class PanelMenuComponent extends React.Component {
    ...
    renderPanel(item, index) {
        ...
        const headerClassName = classNames('p-component p-panelmenu-header', { 'p-highlight': active, 'p-disabled': item.disabled } as any);
        const submenuIconClassName = classNames('p-panelmenu-icon pi', { 'pi-chevron-right': !active, ' pi-chevron-down': active } as any);
        const iconClassName = classNames('p-menuitem-icon', item.icon);
        const submenuIcon = item.items && <span className={submenuIconClassName}></span>;
        const itemIcon = item.icon && <span className={iconClassName}></span>;
        const label = item.label && <span className="p-menuitem-text">{item.label}</span>;
        const contentWrapperClassName = classNames('p-toggleable-content', { 'p-toggleable-content-collapsed': !active } as any);
