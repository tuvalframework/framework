...
export class AutoComplete extends React.Component {
    ...
    renderDropdown() {
        return <ButtonComponent ref={(el) => this.dropdownButton = el} type="button" icon={this.props.dropdownIcon} className="p-autocomplete-dropdown" disabled={this.props.disabled} onClick={this.onDropdownClick} />
    }
