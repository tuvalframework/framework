...
export class SplitterComponent extends React.Component {
    ...
    onGutterTouchStart(event, index) {
        ...
        (window as any).addEventListener('touchmove', this.windowTouchMoveListener, { passive: false, cancelable: false });
        ...
        if (this.props.children && this.props.children.length) {
            ...
            if (!initialized) {
                ...
                this.props.children.map((panel, i) => {
                    ...
                    if (panelSize < 0) {
                        children[i].style.flexBasis = panelSize + 'px';
                    } else {
