...
export class MenuComponent extends React.Component {
    ...
    bindScrollListener() {
        if (!this.scrollHandler) {
            this.scrollHandler = new (ConnectedOverlayScrollHandler as any)(this.target, (event) => {
                if (this.state.visible) {
                    this.hide(event);
                }
            });
    ...
    renderSubmenu(submenu, index) {
        const className = classNames('p-submenu-header', { 'p-disabled': submenu.disabled } as any, submenu.className);
    ...
    renderElement() {
        if (this.props.model) {
            const className = classNames('p-menu p-component', this.props.className, { 'p-menu-overlay': this.props.popup } as any);
