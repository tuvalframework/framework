...
export interface ITracker {
     ...
     */
    configure(options: ITrackerConfigureOptions): boolean;
     ...
     */
    install(options: ITrackerInstallOptions): boolean;
...
export interface ITrackerCustomerSection {
...
export interface ITrackerConsoleSection {
...
export interface ITrackerEnvironmentSection {
...
export interface ITrackerNavSection {
...
export interface ITrackerNetworkSection {
...
export interface ITrackerVisitorSection {
    /** timestamp the event occurred */
    timestamp: ISO8601DateString;
 ...
 */
export interface ITrackerCaptureItem {
    ...
    nav: ITrackerNavSection[];
    /** Network Telemetry */
    network: ITrackerNetworkSection[];
    ...
    visitor: ITrackerVisitorSection[];
...
export interface ITrackerConfigureOptions {
     ...
     */
    onError?: (payload: ITrackerCaptureItem, error?: Error) => boolean;
...
export interface ITrackerInstallOptions extends ITrackerConfigureOptions {
...
export const Tracker: ITracker = TrackJS;
...
/* TrackJS.install({
    token: '1d74474e4c1f4a5b840066b4cb6f02d1',
