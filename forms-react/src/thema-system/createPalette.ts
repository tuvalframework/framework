...
export interface TypeBackground {
    ...
    grey: string;
    /**Grey background color, stays grey in dark and black themes */
    allgrey: string;
}
...
export const light: PaletteOptions = {
    ...
    background: {
        ...
        primary: 'var(--application-background-color)',
        secondary: 'var(--secondary-background-color)',
        primaryHover: 'var(--primary-background-hover-color)',
        inverted: '#323338',
        grey: '#F6F7FB',
        allgrey: '#F6F7FB'
    },
...
function getDefaultSecondary(mode = 'light'): SimplePaletteColorOptions {
    if (mode === 'dark') {
        return {
            main: purple[200],
            light: purple[50],
...
function getDefaultError(mode = 'light'): SimplePaletteColorOptions {
    if (mode === 'dark') {
        return {
            main: red[500],
            light: red[300],
...
function getDefaultInfo(mode = 'light'): SimplePaletteColorOptions {
    if (mode === 'dark') {
        return {
            main: lightBlue[400],
            light: lightBlue[300],
...
function getDefaultSuccess(mode = 'light'): SimplePaletteColorOptions {
    if (mode === 'dark') {
        return {
            main: green[400],
            light: green[300],
...
function getDefaultWarning(mode = 'light'): SimplePaletteColorOptions {
    if (mode === 'dark') {
        return {
            main: orange[400],
            light: orange[300],
...
export function createPalette(palette): Palette {
