...
export const useProtocol = (provider: symbol | string) => {
    ...
    return {
      ...
      `
        ...
        _delete: <RecordType extends RaRecord = any, MutationError = unknown>(resource?: string, params: Partial<DeleteParams<RecordType>> = {}, options: UseDeleteOptions<RecordType, MutationError> = {}): UseDeleteResult<RecordType, MutationError> => {
            ...
            const mutation = (useMutation as any)(
                ({
                    ...
                    dataProvider['delete'](callTimeResource, callTimeId),
                /*  dataProvider
            ...
            resultObject['isLoading'] = mutation.isLoading;
            resultObject['isSuccess'] = mutation.isSuccess;
            resultObject['mutate'] = async (id: string | number, updateOptions: any = {}) => {
