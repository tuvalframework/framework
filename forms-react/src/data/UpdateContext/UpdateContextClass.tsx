...
export class UpdateContextClass extends UIView {
    ...
    @ViewProperty() vp_Children: (update?: Function, data?: any, isLoading?: boolean, isUpdating?: boolean, isSuccess?: boolean) => UIView;
    public children(value: (update?: Function, data?: any, isLoading?: boolean, isUpdating?: boolean, isSuccess?: boolean) => UIView): this {
