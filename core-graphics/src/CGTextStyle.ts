...
const defaultStyle: ICGTextStyle = {
    align: 'left',
    breakWords: false,
    dropShadow: false,
    dropShadowAlpha: 1,
...
export class CGTextStyle implements ICGTextStyle
{
    ...
    protected _align: TextStyleAlign = 'left' ;
    protected _breakWords: boolean = false;
    protected _dropShadow: boolean = false;
    protected _dropShadowAlpha: number = 0;
    protected _dropShadowAngle: number = 0;
    protected _dropShadowBlur: number = 0;
    protected _dropShadowColor: string|number = undefined as any;
    protected _dropShadowDistance: number = 0;
    protected _fill: TextStyleFill =  undefined as any;;
    protected _fillGradientType: TEXT_GRADIENT = TEXT_GRADIENT.LINEAR_VERTICAL ;
    protected _fillGradientStops: number[] = undefined as any;
    protected _fontFamily: string =  TString.Empty;
    protected _fontSize: number = 0;
    protected _fontStyle: TextStyleFontStyle = 'normal';
    protected _fontVariant: TextStyleFontVariant = 'normal';
    protected _fontWeight: TextStyleFontWeight = 'normal' ;
    protected _letterSpacing: number = 0;
    protected _lineHeight: number = 0;
    protected _lineJoin: TextStyleLineJoin = 'miter';
    protected _miterLimit: number = 0;
    protected _padding: number = 0;
    protected _stroke: string|number= undefined as any;;
    protected _strokeThickness: number = 0;
    protected _textBaseline: TextStyleTextBaseline = 'alphabetic';
    protected _trim: boolean = false;
    protected _whiteSpace: TextStyleWhiteSpace = 'normal';
    protected _wordWrap: boolean = false;
    protected _wordWrapWidth: number = 0;
     ...
     */
    public clone(): CGTextStyle
    {
        const clonedProperties: Partial<ICGTextStyle> = {};
